@Code
    ...
    Validation.Add("confirmPassword",
        Validator.EqualsTo("password", "The password and confirmation password do not match."))
...
<form method="post">
    ...
    <fieldset>
        ...
        <p>
            ...
            Click <a href="~/Account/login">here</a> to log in using one of the supported services.
        </p>
    </fieldset>
</form>